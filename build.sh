...
docker build -t erblast/r_conda:3.6.0 r_conda/
docker build -t erblast/r_conda_snakemake:3.6.0 r_conda_snakemake/
docker build -t erblast/r_conda_snakemake_pkgs:3.6.0 r_conda_snakemake_pkgs/

# upload to docker hub ---------------------------------------------------------------
docker push erblast/r_conda:3.6.0
docker push erblast/r_conda_snakemake:3.6.0
docker push erblast/r_conda_snakemake_pkgs:3.6.0

# overwrite latest tag (optional) -----------------------------------------------------
docker tag erblast/r_conda:3.6.0  erblast/r_conda:latest
docker tag erblast/r_conda_snakemake:3.6.0 erblast/r_conda_snakemake:latest
